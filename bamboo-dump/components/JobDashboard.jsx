                ...
                <div className="lg:col-span-8" ref={resultsRef}>
                    ...
                    <div className="space-y-4">
                        ...
                        {!isMatching && displayedJobs.length === 0 && (
                            ...
                            >
                                <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-sm border ${searchError ? 'bg-red-50 border-red-100' : 'bg-white border-gray-100'}`}>
                                    {searchError ? (
                                ...
                                <h3 className={`font-medium mb-1 ${searchError ? 'text-red-600' : 'text-gray-900'}`}>
                                    {searchError ? 'Search Failed' : activeTab === 'saved' ? 'No Saved Jobs Yet' : 'Ready to Hunt'}
                                </h3>
