    ...
    return (
        <main className="min-h-screen bg-white dark:bg-ink-950 py-16 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <h1 className="text-4xl font-bold text-ink-900 dark:text-ink-100 mb-2">Privacy Policy</h1>
                <p className="text-sm text-ink-400 dark:text-ink-500 mb-8">Last updated: March 2, 2026</p>

                <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
                    <section>
                        <h2 className="text-xl font-semibold text-ink-900 dark:text-ink-100 mb-3">1. Information We Collect</h2>
                        <p className="text-ink-600 dark:text-ink-400 text-sm leading-relaxed">
                            When you use Midas, we process the following data:
                        </p>
                        <ul className="list-disc pl-5 text-sm text-ink-600 dark:text-ink-400 space-y-1 mt-2">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-ink-900 dark:text-ink-100 mb-3">2. How We Use Your Data</h2>
                        <ul className="list-disc pl-5 text-sm text-ink-600 dark:text-ink-400 space-y-1">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-ink-900 dark:text-ink-100 mb-3">3. Third-Party Services</h2>
                        <p className="text-ink-600 dark:text-ink-400 text-sm leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-ink-900 dark:text-ink-100 mb-3">4. AI Training Disclaimer</h2>
                        <p className="text-ink-600 dark:text-ink-400 text-sm leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-ink-900 dark:text-ink-100 mb-3">5. Data Retention</h2>
                        <p className="text-ink-600 dark:text-ink-400 text-sm leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-ink-900 dark:text-ink-100 mb-3">6. Your Rights</h2>
                        <p className="text-ink-600 dark:text-ink-400 text-sm leading-relaxed">
                        ...
                        <p className="text-ink-600 dark:text-ink-400 text-sm leading-relaxed mt-2">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-ink-900 dark:text-ink-100 mb-3">7. Contact</h2>
                        <p className="text-ink-600 dark:text-ink-400 text-sm leading-relaxed">
