...
function ScorePopover({ job, onClose }) {
    ...
    return (
        <div ref={ref} className="absolute right-0 top-full mt-2 z-50 w-[min(90vw,320px)] glass-card rounded-xl shadow-xl border border-outline-variant/10 p-5 animate-in fade-in slide-in-from-top-2 duration-200">
            {/* Top stats */}
            <div className="flex items-baseline gap-6 mb-5 pb-4 border-b border-outline-variant/10">
            ...
            <Link
                ...
                className="flex items-center justify-center gap-2 mt-5 pt-4 border-t border-outline-variant/10 text-[13px] font-medium text-teal-600 hover:text-teal-700 transition-colors"
            >
                View Full Analysis
            </Link>
        </div>
    ...
    return (
        <div className="max-w-[1100px] space-y-0">
            ...
            {filteredApps.length === 0 && filter === 'all' ? (
                <div className="glass-card rounded-xl border border-outline-variant/10 p-16 text-center">
                ...
                <div className="glass-card rounded-xl border border-outline-variant/10 overflow-hidden">
                    {/* Tabs */}
                    <div className="flex items-center justify-between border-b border-outline-variant/10">
                        <div className="flex">
                            {tabs.map(tab => (
                                <button
                                    key={tab.id}
                    ...
                    {/* Column headers */}
                    <div className="hidden md:grid grid-cols-[40px,1fr,180px,120px,100px,80px] items-center gap-0 px-4 py-2.5 bg-gray-50/80 border-b border-outline-variant/10 text-[11px] font-medium text-gray-400 uppercase tracking-wider select-none">
                    ...
                    <div className={`px-5 py-2.5 border-t border-outline-variant/10 flex items-center justify-between transition-colors ${
            ...
            {appliedJobsData.length > 0 && (
                <div className="mt-5 glass-card border border-outline-variant/10 rounded-xl p-4 flex items-start gap-3">
