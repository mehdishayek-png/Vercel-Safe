    ...
    return (
        <main className="min-h-screen bg-white dark:bg-[#0f1117] py-16 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <p className="text-lg text-gray-500 dark:text-gray-400 mb-10">AI-powered job matching, built for job seekers who value their time.</p>
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
                    ...
                    <section>
                        ...
                        <ol className="list-decimal pl-5 text-sm text-gray-600 dark:text-gray-400 space-y-2 mt-2">
