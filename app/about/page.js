    ...
    return (
        <main className="min-h-screen bg-white dark:bg-[#0f1117] py-16 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">About Midas Match</h1>
                <p className="text-lg text-gray-500 dark:text-gray-300 mb-10">AI-powered job matching, built for job seekers who value their time.</p>

                <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Our Mission</h2>
                    ...
                    <hr className="border-gray-100 dark:border-[#2d3140]" />

                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">How It Works</h2>
                        <ol className="list-decimal pl-5 text-sm text-gray-600 dark:text-gray-300 space-y-2 mt-2">
                    ...
                    <section>
                        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">What Makes Us Different</h2>
                        <div className="space-y-4 mt-2">
                            <div>
                                <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200">Direct ATS Access</h3>
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200">Privacy First</h3>
                                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mt-1">
                                    Your resume is parsed in-memory and never stored on our servers. We explicitly opt out of AI training with all providers.
                                </p>
                            </div>
                            <div>
                                <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-200">Transparent Scoring</h3>
                                <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mt-1">
