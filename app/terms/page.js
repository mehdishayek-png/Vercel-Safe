                ...
                <div className="prose prose-gray max-w-none space-y-6">
                    <section>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            JobBot AI is an AI-powered job matching platform that analyzes your resume and preferences to find relevant job opportunities from multiple sources including Google Jobs, WeWorkRemotely, Lever, RemoteOK, and others.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            JobBot AI is provided &quot;as is&quot; without warranties of any kind. We are not liable for any damages arising from the use of this service, including but not limited to missed job opportunities, inaccurate match scores, or service interruptions.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            For questions regarding these terms, contact us at <a href="mailto:support@jobbot.ai" className="text-indigo-600 hover:underline">support@jobbot.ai</a>.
                        </p>
                    </section>
                </div>
            </div>
