    ...
    <div className="relative min-h-screen flex items-center justify-center bg-ink-950 overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/"
            className="inline-flex items-center justify-center px-6 py-3 rounded-[10px] bg-gradient-to-r from-amber-500 to-yellow-500 text-ink-950 font-semibold text-sm hover:from-amber-400 hover:to-yellow-400 transition-all shadow-lg shadow-amber-500/25"
          >
            Go Home
          </Link>
          <Link
