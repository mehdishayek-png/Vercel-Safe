        ...
        <section className="py-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-4xl">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-900 dark:text-white text-lg">Three steps to your next opportunity.</p>
                </div>
                        ...
                        {steps.map((s, i) => (
                            ...
                            >
                                ...
                                <div className="pt-1">
                                    ...
                                    <p className="text-gray-900 dark:text-white text-sm leading-relaxed">{s.desc}</p>
                                </div>
                            </motion.div>
                        ))}
                    </div>
