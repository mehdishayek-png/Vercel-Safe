        ...
        <section className="py-28 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="mb-16">
                    ...
                    <h2 className="font-headline text-3xl md:text-5xl font-extrabold tracking-tight mb-4 text-gray-900">Three steps to your next role</h2>
                    <p className="text-gray-500 text-lg max-w-xl">No complexity. Upload, scan, apply.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
                    ...
                    {steps.map((s, i) => (
                        ...
                        >
                            ...
                            <span className="text-5xl font-headline font-extrabold text-surface-200 mb-4 block">{s.num}</span>
                            <h3 className="font-headline text-xl font-bold text-gray-900 mb-3">{s.title}</h3>
