        ...
        <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden">
            ...
            <div className="container mx-auto px-4 text-center z-10 max-w-4xl">
                <motion.div
                    ...
                    className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-50 border border-brand-200 mb-8"
                >
                    <span className="relative flex h-2 w-2">
                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-brand-400 opacity-75"></span>
                        <span className="relative inline-flex rounded-full h-2 w-2 bg-brand-500"></span>
                    </span>
                    <span className="text-xs font-medium text-brand-700 tracking-wide">AI-Powered Job Search Agent</span>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="mt-20 flex flex-wrap justify-center gap-x-8 gap-y-2"
                >
