            ...
            <header className="sticky top-0 w-full z-40 bg-white/60 dark:bg-slate-950/60 backdrop-blur-2xl shadow-[0_4px_30px_rgba(0,0,0,0.03)] h-16 px-8 flex justify-between items-center">
                <div className="flex items-center gap-8 flex-1">
                    ...
                    <div className="relative w-full max-w-md">
                        ...
                        <input
                            className="w-full pl-10 pr-4 py-2 bg-surface-100 dark:bg-[#22252f] border-none rounded-full text-sm focus:ring-2 focus:ring-brand-500/20 transition-all"
                ...
                <div className="flex items-center gap-4">
                    {typeof tokenBalance === 'number' && (
                        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-surface-100 dark:bg-[#22252f] text-[11px] font-semibold text-slate-500">
