...
export function OnboardingPanel({ isParsing, fileInputRef, handleFileUpload }) {
    return (
        <>
            ...
            <div className="bg-white dark:bg-[#1a1d27] rounded-xl border border-surface-200 dark:border-[#2d3140] p-5">
                ...
                <div className="space-y-3">
                    <div className="flex gap-3 items-start">
                        ...
                        <div>
                            <p className="text-[13px] font-medium text-gray-900 dark:text-gray-100">Upload your resume</p>
                    ...
                    <div className="flex gap-3 items-start">
                        ...
                        <div>
                            <p className="text-[13px] font-medium text-gray-900 dark:text-gray-100">Refine your profile</p>
                    ...
                    <div className="flex gap-3 items-start">
                        ...
                        <div>
                            <p className="text-[13px] font-medium text-gray-900 dark:text-gray-100">Scan the market</p>
            ...
            {/* Tips */}
            <div className="bg-gradient-to-br from-brand-50 to-accent-50 dark:from-brand-900/20 dark:to-accent-900/20 rounded-xl border border-brand-100 dark:border-brand-800 p-5">
                <div className="text-[10px] font-semibold tracking-widest text-brand-600 uppercase mb-3">Tips for best results</div>
                <ul className="space-y-2 text-[12px] text-gray-600 dark:text-gray-300">
