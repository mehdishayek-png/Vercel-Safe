...
export function MatchResultsGrid({
    ...
    return (
        <>
            {/* Tab bar */}
            <div className="flex items-center gap-1 border-b border-ink-200 dark:border-[#2E2B27] mb-5 overflow-x-auto">
                {tabs.map((tab) => (
                    <button
                        key={tab.key}
                ...
                {jobs.length > 0 && (
                    ...
                    <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium text-ink-500 hover:text-brand-600 hover:bg-brand-50 transition-colors cursor-pointer"
                        title="Export to CSV"
                    >
                    ...
                    <div className="flex items-center gap-0.5 bg-surface-100 rounded-lg p-0.5">
                        <button
                            ...
                            className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all cursor-pointer ${
                                sortBy === 'score' ? 'bg-white dark:bg-[#1C1B19] text-brand-600 shadow-sm' : 'text-ink-500 hover:text-ink-700 dark:hover:text-ink-300'
                            }`}
                        >
                            Score
                        </button>
                        <button
                            ...
                            className={`px-2.5 py-1 rounded-md text-xs font-medium transition-all cursor-pointer ${
                                sortBy === 'latest' ? 'bg-white dark:bg-[#1C1B19] text-brand-600 shadow-sm' : 'text-ink-500 hover:text-ink-700 dark:hover:text-ink-300'
                            }`}
                        >
                            Latest
                        </button>
            ...
            <div className="space-y-4">
                ...
                {searchError && !isMatching && (
                    <motion.div
                        ...
                        className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-[10px] p-4 flex items-start gap-3"
                    >
                ...
                {deepAnalysisProgress && (
                    <motion.div
                        initial={{ opacity: 0, y: -10 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="sticky top-16 z-40 bg-brand-500 text-white rounded-[10px] px-5 py-3 shadow-lg flex items-center gap-4"
                    >
            ...
            {displayedJobs.length === 0 && !isMatching && !searchError && (
                <div className="space-y-5 mt-2 relative z-10">
                    {/* Hero card */}
                    <div className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-indigo-900/20 dark:via-[#1C1B19] dark:to-violet-900/20 rounded-[14px] border border-indigo-100/60 dark:border-indigo-800/30 p-8 text-center shadow-sm">
                        {/* Decorative blobs */}
                        ...
                        <div className="relative">
                            <div className="w-14 h-14 bg-gradient-to-br from-indigo-100 to-violet-100 rounded-[14px] flex items-center justify-center mx-auto mb-4 shadow-sm">
                                <Search className="w-7 h-7 text-brand-600" />
                            </div>
                            <h2 className="text-xl font-bold text-ink-900 dark:text-ink-100 mb-2">Ready to find your next role</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="bg-gradient-to-br from-white to-indigo-50/40 dark:from-[#1C1B19] dark:to-indigo-900/10 rounded-[10px] border border-indigo-100/50 dark:border-indigo-800/30 p-5 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-[13px] font-semibold text-ink-900 dark:text-ink-100 mb-1">AI-Powered Matching</h3>
                        ...
                        <div className="bg-gradient-to-br from-white to-emerald-50/40 dark:from-[#1C1B19] dark:to-emerald-900/10 rounded-[10px] border border-emerald-100/50 dark:border-emerald-800/30 p-5 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-[13px] font-semibold text-ink-900 dark:text-ink-100 mb-1">4 Job Sources</h3>
                            <p className="text-[11px] text-ink-500 dark:text-ink-400 leading-relaxed">
                                We aggregate from LinkedIn, Indeed, Glassdoor, and Fantastic.Jobs — casting a wide net so you don't miss opportunities.
                            </p>
                        </div>
                        <div className="bg-gradient-to-br from-white to-violet-50/40 dark:from-[#1C1B19] dark:to-violet-900/10 rounded-[10px] border border-violet-100/50 dark:border-violet-800/30 p-5 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-[13px] font-semibold text-ink-900 dark:text-ink-100 mb-1">Deep Analysis</h3>
                            <p className="text-[11px] text-ink-500 dark:text-ink-400 leading-relaxed">
                                Expand any job card to get AI-powered fit scores, salary estimates, skill gap analysis, and a personalized verdict.
                            </p>
                        </div>
                        <div className="bg-gradient-to-br from-white to-sky-50/40 dark:from-[#1C1B19] dark:to-sky-900/10 rounded-[10px] border border-sky-100/50 dark:border-sky-800/30 p-5 shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h3 className="text-[13px] font-semibold text-ink-900 dark:text-ink-100 mb-1">Cover Letters</h3>
                            <p className="text-[11px] text-ink-500 dark:text-ink-400 leading-relaxed">
                    ...
                    {/* How scoring works */}
                    <div className="bg-gradient-to-br from-white to-slate-50/50 dark:from-[#1C1B19] dark:to-slate-900/20 rounded-[10px] border border-slate-200/60 dark:border-slate-700/30 p-5 shadow-sm">
                        <h3 className="text-xs font-semibold text-ink-500 uppercase tracking-wider mb-4 flex items-center gap-1.5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
                            <div className="bg-indigo-50/50 dark:bg-indigo-900/20 rounded-lg py-3 px-2">
                                ...
                                <div className="text-[11px] text-ink-500 font-medium">Scoring Signals</div>
                                <div className="text-[10px] text-ink-400 mt-1 leading-relaxed">Keywords, seniority, location, role family, depth, recency, prestige</div>
                            </div>
                            <div className="bg-emerald-50/50 dark:bg-emerald-900/20 rounded-lg py-3 px-2">
                                ...
                                <div className="text-[11px] text-ink-500 font-medium">Match Score</div>
                                <div className="text-[10px] text-ink-400 mt-1 leading-relaxed">Composite score with multipliers — 80+ is an excellent fit</div>
                            </div>
                            <div className="bg-violet-50/50 dark:bg-violet-900/20 rounded-lg py-3 px-2">
                                ...
                                <div className="text-[11px] text-ink-500 font-medium">Scan Time</div>
                                <div className="text-[10px] text-ink-400 mt-1 leading-relaxed">Fetches and scores hundreds of jobs in under a minute</div>
                            </div>
                        </div>
                    </div>

                    {/* Privacy footer */}
                    <div className="flex items-center justify-center gap-4 text-[10px] text-ink-400 py-2">
                        ...
                        <span className="w-px h-3 bg-surface-200" />
                        <span className="flex items-center gap-1"><Download className="w-3 h-3 text-ink-400" /> Export to CSV</span>
                    </div>
                </div>
            )}
            ...
            {searchSuggestions && searchSuggestions.length > 0 && displayedJobs.length > 0 && (
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/10 dark:to-orange-900/10 border border-amber-200 dark:border-amber-800 rounded-[10px] p-4 mt-2"
                >
                    ...
                    <div className="flex flex-wrap gap-2">
                        {searchSuggestions.map((title, i) => (
                            <button
                                ...
                                className="px-3 py-1.5 text-xs font-medium bg-white dark:bg-[#1C1B19] border border-amber-200 dark:border-amber-700 text-amber-700 dark:text-amber-400 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/20 hover:border-amber-300 transition-all cursor-pointer"
                            >
                                {title}
                            </button>
                        ))}
...
function CompanyGroupHeader({ company, jobs, isOpen, onToggle }) {
    ...
    return (
        <button
            onClick={onToggle}
            className="w-full flex items-center gap-3 p-3 px-4 bg-gradient-to-r from-surface-50 to-white dark:from-[#1F1E1B] dark:to-[#1C1B19] border border-ink-200 dark:border-[#2E2B27] rounded-[10px] hover:border-brand-200 transition-all cursor-pointer"
        >
            <CompanyLogo company={company} size={28} colorIndex={0} />
            <div className="flex-1 min-w-0 text-left">
                <span className="text-[13px] font-semibold text-ink-900 dark:text-ink-100">{company}</span>
                <span className="text-[11px] text-ink-400 ml-2">{jobs.length} open roles</span>
            </div>
