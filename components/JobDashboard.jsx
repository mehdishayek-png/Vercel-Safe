...
import { Upload, Loader2, ShieldCheck, BrainCircuit, ChevronDown, Sparkles } from 'lucide-react';
        ...
        try {
            const res = await fetch('/api/match-jobs', {
                ...
                body: JSON.stringify({
                    ...
                    apiKeys,
                    preferences: { ...preferences, location: locationQuery, midasSearch, filters }
                })
            });
                    ...
                    {profile && (
                        <>
                            ...
                            <div className="bg-white rounded-xl border border-surface-200 p-5">
                                ...
                                <div className="text-lg font-bold text-gray-900 mb-0.5">{profile.name}</div>
