        ...
        <section className="py-20 relative overflow-hidden">
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-700 max-w-2xl mx-auto text-sm md:text-base">Every job is scored through independent multipliers — seniority alignment, location enforcement, role family detection, and semantic similarity.</p>
                </div>
                ...
                <div className="bg-white border border-surface-200 rounded-xl shadow-card p-5">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-xs font-semibold text-gray-600 uppercase tracking-wider">Active Multipliers</span>
                    </div>
                    <div className="flex flex-wrap gap-2">
                        {MULTIPLIERS.map((m, i) => (
                            <div key={i} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-surface-50 border border-surface-200 text-sm text-gray-600">
