        ...
        <section className="py-20 relative overflow-hidden">
            <div className="container mx-auto px-4 max-w-5xl">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base">Every job is scored through independent multipliers — seniority alignment, location enforcement, role family detection, and semantic similarity.</p>
                </div>
