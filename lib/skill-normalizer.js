...
const COMPOUND_BREAKDOWNS = {
    ...
    'structural analysis and design': ['STAAD', 'structural'],
    'construction project management': ['construction', 'project management'],
    'quantity surveying': ['QS', 'estimation'],
    'site supervision and management': ['site management'],
    'green building design': ['LEED', 'green building'],
    'construction cost estimation': ['estimation', 'BOQ'],
};
...
const KNOWN_SHORT_TERMS = new Set([
    ...
    // Construction / AEC / CAD
    'autocad', 'revit', 'sketchup', 'staad', 'etabs', 'primavera', 'navisworks',
    'bim', 'cad', 'tekla', 'solidworks', 'catia', '3ds max', 'lumion', 'vray',
    'photoshop', 'illustrator', 'indesign', 'rhino', 'grasshopper', 'archicad',
    'ms project', 'bluebeam', 'procore', 'plangrid', 'fieldwire', 'aconex',
]);
...
const HIGH_VALUE_TERMS = new Set([
    ...
    // Construction / AEC
    'autocad', 'revit', 'bim', 'staad', 'primavera', 'sketchup', 'etabs', 'procore',
]);
