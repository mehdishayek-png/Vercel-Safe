...
const ROLE_FAMILIES = {
    ...
    // EXPANDED: added video editor, videographer, production assistant/coordinator, motion graphics
    // to prevent these common titles from being unclassifiable (which kills same-family detection).
    content: ['content strategist', 'content creator', 'copywriter', 'content manager', 'technical writer', 'documentation engineer', 'content lead', 'content specialist', 'content writer', 'production manager', 'content producer', 'video producer', 'media producer', 'post-production', 'film producer', 'showrunner', 'assistant director', 'cinematographer', 'media operations',
        // Video production titles
        'video editor', 'video production', 'videographer', 'production assistant', 'production coordinator',
        'motion graphics', 'motion designer', 'animator', 'vfx artist', 'colorist', 'color grading',
        'sound designer', 'audio engineer', 'podcast producer', 'broadcast',
        // Photo/creative
    ...
    consulting: ['consultant', 'advisory', 'strategy consultant', 'management consultant', 'deal advisory', 'transaction advisory', 'due diligence', 'valuation analyst', 'corporate finance', 'restructuring', 'business analyst', 'engagement manager'],
};
