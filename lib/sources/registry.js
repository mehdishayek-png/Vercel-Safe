...
export const SOURCE_REGISTRY = [
    ...
    // ---- API sources ----
    // PRIMARY: DataForSEO Google Jobs (real structured Google Jobs data, ~$0.002/search)
    {
        ...
        makeFetcher: (ctx) => () => ctx._fetchDataForSEO(ctx.activeQueries.slice(0, 5), ctx.location),
    },
    ...
    },
    {
        ...
        remoteOnly: false, midasOnly: false, geo: 'india', querySlice: 0, needsLocation: false,
