...
export const SOURCE_REGISTRY = [
    ...
    },
    {
        ...
        remoteOnly: false, midasOnly: false, querySlice: 6, midasQuerySlice: 10, needsLocation: true,
        apiKeyEnvs: ['JSEARCH_KEY'],
        makeFetcher: (ctx) => {
            const slice = ctx.isMidasSearch ? 10 : 6;
    ...
    {
        name: 'LinkedIn (Fantastic)', cacheId: 'linkedin-search', type: 'api', enabled: true,
        remoteOnly: false, midasOnly: false, querySlice: 3, needsLocation: true,
        apiKeyEnvs: ['JSEARCH_KEY'],
        makeFetcher: (ctx) => () => ctx._fetchLinkedInJobSearch(ctx.activeQueries.slice(0, 3), ctx.location, ctx.resolvedKeys.JSEARCH_KEY),
    },
    {
        name: 'ActiveJobsDB', cacheId: 'activejobsdb', type: 'api', enabled: true,
        remoteOnly: false, midasOnly: false, querySlice: 3, needsLocation: true,
        apiKeyEnvs: ['JSEARCH_KEY'],
