...
import { fetchApifyAggregators } from './sources/apify-aggregators.js';
...
export async function fetchAllJobsStreaming(profile, apiKeys = {}, onSourceComplete, onProgress, preferences = {}) {
  ...
  onSourceComplete = (sourceName, fetchedJobs) => {
      ...
      if (uniqueNewJobs.length > 0) {
          originalOnSourceComplete(sourceName, uniqueNewJobs);
      }
  };
  ...
  const ctx = {
    ...
    _fetchBingJobs: fetchBingJobs, _fetchApifyNaukri: fetchApifyAggregators,
