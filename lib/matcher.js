...
function scoreLocally(job, primaryKw, secondaryKw, titleWords, candidateYears, candidateHeadline, countryAliases, cityAliases) {
  ...
  if (countryAliases && countryAliases.length > 0) {
    ...
    if (exactCityMatch) {
      locationMultiplier = 3.0; // Exact city — massive dominant buff
  ...
  const score = (baseScore + finalEarned) * titleSynergyPenalty * seniorityPenalty * recencyMultiplier * languageMultiplier * locationPenalty;
