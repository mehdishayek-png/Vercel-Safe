// ============================================
// TITLE SYNONYMS (Role Family Definitions)
// ============================================

export const TITLE_SYNONYMS = {
    // Construction & Project Management & AEC
    'construction': ['construction', 'building', 'project', 'site', 'contractor', 'general contractor', 'civil', 'structural'],
    'construction manager': ['construction manager', 'construction supervisor', 'project manager', 'site manager', 'construction lead', 'project coordinator', 'pm', 'site engineer', 'planning engineer', 'project engineer', 'construction engineer', 'quantity surveyor', 'estimator'],
    'project manager': ['project manager', 'program manager', 'construction manager', 'project lead', 'pm', 'pmo', 'delivery manager'],
    'construction supervisor': ['construction supervisor', 'site supervisor', 'construction manager', 'foreman', 'site lead', 'site engineer'],
    'site engineer': ['site engineer', 'site manager', 'construction engineer', 'project engineer', 'construction manager', 'field engineer'],
    'civil engineer': ['civil engineer', 'structural engineer', 'construction engineer', 'site engineer', 'design engineer', 'project engineer'],
    'architect': ['architect', 'architectural designer', 'design architect', 'project architect', 'senior architect', 'interior designer', 'urban designer'],
    'interior designer': ['interior designer', 'interior architect', 'space designer', 'interior decorator', 'design consultant'],
    'quantity surveyor': ['quantity surveyor', 'qs', 'cost engineer', 'estimator', 'cost consultant', 'cost manager', 'billing engineer'],
    ...
    // Strategic CX / B2B SaaS (Advanced)
    ...
    'customer experience specialist': ['customer experience specialist', 'cx specialist', 'customer success manager', 'client experience manager', 'customer operations', 'solutions consultant', 'technical account manager', 'product operations'],
    'product operations': ['product operations', 'product support', 'product ops', 'customer experience', 'cx specialist', 'customer success', 'customer operations', 'technical account manager', 'implementation'],
    ...
    'technical support': ['technical support', 'it support', 'support engineer', 'tech support'],
    ...
    'sales': ['sales', 'business development', 'account executive', 'sales representative', 'sales engineer', 'lead generation'],
    'lead generation': ['lead generation', 'bdr', 'sdr', 'sales', 'business development', 'inside sales'],
