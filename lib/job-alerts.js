...
export async function getAlertProfile(userId) {
    ...
    try {
        ...
        warn(`[alerts] Failed to get alert profile for ${userId}: ${err.message}`);
        return null;
    }
}
...
export async function getUniqueQueries() {
    ...
    try {
        ...
        warn(`[alerts] Failed to get unique queries: ${err.message}`);
        return [];
    }
}
...
export async function getJobPool() {
    ...
    try {
        ...
        warn(`[alerts] Failed to get job pool: ${err.message}`);
        return [];
    }
}
...
export async function getSeenJobs(userId) {
    ...
    try {
        ...
        warn(`[alerts] Failed to get seen jobs for ${userId}: ${err.message}`);
        return new Set();
    }
}
