...
export const DEFAULT_FEATURE_FLAGS = {
    ADVANCED_FILTERS: true,     // Master switch — on by default, kill via Redis/env if needed
    SALARY_FILTER: true,        // Salary filter
    COMPANY_SIZE_FILTER: true,  // Company size filter
    MULTI_REGION: true,         // Multi-region vs single country
};
